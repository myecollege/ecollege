				...
				<div class="lg-zone">
					<div class="lg-box">
						...
						<!-- 	<div class="lg-check clearfix">
							...
							<div class="enter">
								<a href="javascript:;" class="purchaser" onClick="javascript:window.location='/tek/login.do'">采购商登录</a>
								<a href="javascript:;" class="supplier" onClick="javascript:window.location='/tek/login.do'">供应商登录</a>
							</div>
						</form>
					</div>
				</div>
