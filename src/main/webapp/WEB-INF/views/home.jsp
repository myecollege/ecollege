...
<head> 
    ...
    <title>BIM教学信息管理系统</title> 
<link href="<%=basePath%>resources/css/base.css" rel="stylesheet">
<link href="<%=basePath%>resources/css/platform.css" rel="stylesheet">
<link rel="stylesheet" href="<%=basePath%>/resources/custom/uimaker/easyui.css">
</head> 
<body>
    <div class="container">
        <div id="pf-hd">
            <div class="pf-logo">
                <img src="<%=basePath%>resources/images/main/main_logo.png" alt="logo">
            </div>
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img src="<%=basePath%>resources/images/main/user.png" alt="">
                </div>
    ...
    <script type="text/javascript" src="<%=basePath%>/resources/custom/jquery.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>/resources/custom/jquery.easyui.min.js"></script>
